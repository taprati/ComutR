...
By default, comutR provides a colorscheme for the variant classification, but this can be altered using the `variant_colors` and `variant_scheme` arguments.
...
comut(
  data = input_maf,
  ids = c("1", "3", "4", "7"),
  features_of_interest = c("gene_A", "gene_B", "gene_E", "gene_H")
  )
```
